...
#include "singleton/singletons/SingletonBombMazeFactory.h"
#include "singleton/singletons/SingletonEnchantedMazeFactory.h"

Demonstrator::Demonstrator() { ; }

Demonstrator* Demonstrator::mazeGame = 0;
Demonstrator* Demonstrator::getInstance() {
	return mazeGame;
}
/*
...
*/
Maze* Demonstrator::createMazeByAbstactFactory(MazeFactory* mazeFactory) {
...
*/
Maze* Demonstrator::createMazeByBuilder(MazeBuilder* mazeBuilder) {
...
*/
Maze* Demonstrator::createMazeByFactoryMethod(MazeCreator* mazeCreator) {
...
*/
Maze* Demonstrator::createMazeByPrototype(MazePrototypeFactory* mazePrototypeFactory) {
...
Maze* Demonstrator::createMazeBySingleton(const char* name) {
